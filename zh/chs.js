...
var cnItems = {
    ...
    'Most storage is increased by 5% / 10% / 15% / 20% /': '大多数物资的存储上限 +5% / 10% / 15% / 20% /',
    ...
    'Gain +1 base knowledge generation and +900 base knowledge storage': '基础知识产量 +1，基础知识上限 +900',
    'Can roll Iridium deposits on the moon during planet selection': '星球地质特性新增一种：铱矿产量波动',
    'Max quality of geology deposits increased by 5% / 10% / 15% / 20% /': '星球地质特性最大波动值 +5% / 10% / 15% / 20% /',
    'Transport fuel costs reduced by 4% / 8% / 12% / 16% /': '交通燃料成本 -4% / 8% / 12% / 16% /',
    'Coal Powerplants generate +1MW energy': '煤电厂电量 +1MW',
    'Oil Powerplants generate +1kW (2-star) / +2 (4-star)MW energy': '石油发电厂电量 +1MW(白星) / +2MW(银星)',
    'Casinos require 1MW less energy': '赌场电力消耗 -1MW',
    'Mass drivers require 1MW less energy': '质量驱动器电力消耗 -1MW',
    'Solar Swarm Satellites +0.15 Power.': '蜂群卫星发电量 +0.15MW 。',
    ...
    'Reduce time before government can be changed again by -10% / -20% / -30% / -40% / -50% after a revolution.': '社会体制改革的冷却时间 -10% / -20% / -30% / -40% / -50% 。',
    ...
    'Base RNA generation +0.5x / +1x / +1.5x / +2x / +2.5, Base DNA generation +0.25x / +0.5x / +0.75x / +1x / +1.25.': '基础 RNA 增长 +0.5倍 / +1倍 / +1.5倍 / +2倍 / +2.5倍，基础 DNA 增长 +0.25倍 / +0.5倍 / +0.75倍 / +1倍 / +1.25倍。',
