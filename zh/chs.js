...
var cnItems = {
    ...
    'Scrooge': '守财奴',
    'Accumulated $1 Billion Dollars': '资金达到 $1G。',
    ...
    'That\'s one small step for a %0...': '这是你的一小步……',
    ...
    'Expanded a blackhole to 12 solar masses using mass ejectors': '使用质量喷射器把黑洞扩大到12个太阳质量。',
    ...
    'Resonance': '共振',
    'Attuned your race to the multiverse': '使你的种族加入多元宇宙',
    'Do you feel the energy?': '感受到能量了吗？',
    'Enlightenment': '启蒙',
    'Attuned at least one race from every genus to the multiverse': '每个种群都至少一个种族加入多元宇宙',
    'Everyone just sit around and sing kumbaya.': '大家坐成一圈，一起唱Kumbaya。',
    'Gladiator': '角斗士',
    'Defeated every boss type in the spire': '击败尖塔里的每一种首领',
    'Are you not entertained?': '开心吗？',
    'Corrupted': '腐化',
    'Became a demon lord': '成为一名恶魔领主',
    'And you didn\'t even need to make a Faustian bargain': '甚至你不需要去做一笔浮士德式的交易',
    'Mass Extinction': '大灭绝',
    ...
    'Bioseeded in a micro universe as a race that isn\'t small or compact': '在一个微型宇宙用非微型种族完成播种。',
    ...
    'Whitehole': '白洞',
    'Caused a standard blackhole to explode and trigger a new big bang': '引爆黑洞并毁灭一个标准宇宙。',
    ...
    'Destroyed a magic universe': '毁灭一个魔法宇宙',
    'Some spells are forbidden for good reason.': '有些魔法被禁用不是没有道理的。',
    'Full Metal': '全金属',
    'Transmute an advanced resource': '转化出一种高级材料',
    'You must destroy to create. That is the law of the universe.': '毁灭后再创造，这是宇宙的准则。',
    'You Shall Pass': '你通过了',
    'Collapsed the universe with unmodified Balorg': '不修改炎魔特质毁灭一个宇宙',
    'You shall not pass! Unless you really want to.': '此路不通！除非你真的想通过。',
    'Joyless': '无趣',
    ...
    'Garbage Pie': '垃圾馅饼',
    'Ascended or Infused the genetic rejects without modifying them': '不对特质作任何改良，让这些基因灾难飞升或恶魔灌注。',
    'Hold nothing, extra onions.': '一地鸡毛，一无所获。',
    'Crossed the Finish Line': '越过终点线',
    'Ascended or Infused during a Cataclysm': '在大灾变模式下完成飞升或恶魔灌注。',
    'Slow but steady wins the race.': '一场缓慢而坚实的胜利。',
    'Blank Slate': '一张白纸',
    ...
    'Supermassive': '超大质量',
    'Increase a blackhole to 100 solar masses using mass ejectors': '使用质量喷射器把黑洞扩大到100个太阳质量。',
    ...
    'Equilibrium': '平衡',
    'Attuned every species to the multiverse': '所有种族全部加入多元宇宙',
    'Perfectly balanced, as all things should be.': '完美的平衡，万物皆然。',
    'Trail Novice': '新手的足迹',
    ...
    'All will be judged a sinner': '所有人都会被判定有罪',
    'Crystal Lake': '水晶湖',
    ...
    'Who you gonna call?': '想找谁求救？',
    'Trick or Treat!': '不给糖果就捣蛋！',
    'Found all 6 Candies and 6 Ghosts during the Trick or Treat event.': '在万圣节活动期间找齐 6 个糖果和 6 个幽灵。',
    'Candy Corn Sucks': '玉米糖烂透了！',
    'Gobble Gobble': '狼吞虎咽',
    ...
    'Enhanced Muscle Fiber': '增强型肌肉纤维',
    'Doubles manual gathering rate': '手动采集效率翻倍',
    'Morphogenesis': '形态发生',
    ...
    'Devotion': '敬拜',
    'Priests are more effective': '牧师们的效率提升',
    'Acolyte': '助手',
    'Ziggurats increase the priest cap': '通灵塔可以提升牧师人数上限',
    'Conviction': '信念',
    'Priests are even more effective': '牧师们的效率进一步提升',
    'Transcendence': '超越',
    'You can unlock both Fanaticism and Anthropology': '狂热信仰与人类学允许共存',
    'Bleeding Effect': '引流措施',
    'Synchronicity': '同步原则',
    'Astral Awareness': '星体认知',
    '20% of Plasmids boost storage in antimatter universe, and 10% of Anti-Plasmids boost storage outside of antimatter universe': '在反物质宇宙，质粒的仓储上限加成为其他宇宙的 20%，其他宇宙，反质粒的仓储上限加成为反物质宇宙的 10%',
    'Blood Remembrance': '鲜血记忆',
    'Keep your Blood Stones after a reset': '重置后依然保有鲜血之石',
    'Blood Sacrifice': '血祭',
    'Earn double the Blood Stones from clearing Spire levels': '清理完一层尖塔后获得双倍的鲜血之石',
