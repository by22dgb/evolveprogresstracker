...
var cnItems = {
    ...
    'April Fools!': '愚人节快乐！',
    'Genetic Memory': '遗传记忆',
    'Reduces cost creep by 0.01': '成本蠕变降低 1%',
    'Animus': '敌意',
    'Reduces cost creep by 0.02': '成本蠕变降低 2%',
    'Divine Remembrance': '神圣的回忆',
    'Reduces cost creep by 0.03': '成本蠕变降低 3%',
    'Divine Proportion': '神圣比例',
    'Reduces cost creep by 0.04': '成本蠕变降低 4%',
    'Genetic Repository': '基因库',
    'Reduces cost creep by 0.05': '成本蠕变降低 5%',
    'Spatial Reasoning': '空间推理',
    'Plasmids boost storage space': '质粒增加了存储空间',
    'Spatial Superiority': '空间优势',
    'Plasmid storage effect +50%': '质粒储存效果 +50%',
    'Spatial Supremacy': '空间霸权',
    'Plasmid storage effect +33%': '质粒储存效果 +33%',
